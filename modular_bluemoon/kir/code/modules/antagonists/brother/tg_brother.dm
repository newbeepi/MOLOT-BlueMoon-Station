...
/datum/antagonist/brother/get_preview_icon()
	...
	brother1.dna.features["ethcolor"] = "#ffb3b3"
	...
	brother2.set_species(/datum/species/fly)
...
/datum/team/brother_team/proc/add_objective(datum/objective/new_objective, needs_target = FALSE)
...
/datum/team/brother_team/proc/forge_single_objective()
	if(prob(50))
		if(LAZYLEN(active_ais()) && prob(100/GLOB.joined_player_list.len))
			...
			add_objective(new /datum/objective/assassinate/once, needs_target = TRUE)
		else
			add_objective(new /datum/objective/assassinate/once, needs_target = TRUE)
	else
